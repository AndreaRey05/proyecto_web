...
function LoginAdmin() {
    ...
    return (
        <div className="min-h-screen bg-[#FFFFFF] flex items-center justify-center">
            <div className="flex w-[480px] bg-white rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="w-48 bg-[#5E0006] relative flex flex-col items-end justify-center p-8 gap-6 overflow-hidden">
                    ...
                    <button
                        ...
                        className={`relative z-10 rounded-xl px-4 py-2 text-sm font-bold tracking-widest transition ${modo === 'login' ? 'bg-white text-[#5E0006]' : 'bg-transparent text-white hover:underline'}`}
                    >
                        LOGIN
                    </button>
                    <button
                        onClick={() => setModo('signin')}
                        className={`relative z-10 text-xs font-medium tracking-widest transition ${modo === 'signin' ? 'bg-white text-[#5E0006] rounded-xl px-4 py-2' : 'text-white hover:underline'}`}
                    >
                        SIGN IN
                    </button>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-10 gap-4">
                    ...
                    <div className="w-full flex items-center justify-between mt-1">
                        ...
                        <button
                            ...
                            className="ml-auto bg-[#5E0006] text-white px-6 py-2 rounded-lg text-sm font-bold tracking-widest hover:bg-[#7a000a] transition"
                        >
                            {modo === 'login' ? 'LOGIN' : 'SIGN IN'}
                        </button>
                    </div>
